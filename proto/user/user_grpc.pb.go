...
type UserServiceClient interface {
	...
	GetUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*User, error)
	GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (UserService_GetUsersClient, error)
	UpdateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error)
	DeleteUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*UserResponse, error)
}
...
func (c *userServiceClient) GetUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (UserService_GetUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/main.UserService/getUsers", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *userServiceClient) DeleteUser(ctx context.Context, in *UserUUID, opts ...grpc.CallOption) (*UserResponse, error) {
	out := new(UserResponse)
...
type UserServiceServer interface {
	...
	GetUser(context.Context, *UserUUID) (*User, error)
	GetUsers(*emptypb.Empty, UserService_GetUsersServer) error
	UpdateUser(context.Context, *User) (*User, error)
	DeleteUser(context.Context, *UserUUID) (*UserResponse, error)
...
func _UserService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUser(ctx, req.(*UserUUID))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).DeleteUser(ctx, req.(*UserUUID))
	}
	return interceptor(ctx, in, info, handler)
}
